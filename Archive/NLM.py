...
class NLM(object):
	def __init__(self, tab, X, dim = 2, nhidden=128, nwords = 3, vocabSize = 8000, nonlinear=True, generate = False): # change everything to single precision
		self.X = X
...
model.train(res, res1, epochs = 100, lr = 0.05, debug = True)
